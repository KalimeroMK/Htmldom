...
class Htmldom
{
     ...
     * @return void
     */
    protected function remove_noise($pattern, bool $remove_tag = false)
    {
        global $debug_object;
     ...
     *
     * @return false|Htmldom [type]                    [description]
     */
     ...
     */
    public function dump_html_tree($node, bool $show_attr = true, int $deep = 0)
    {
        $this->dump($node);
    }
     ...
     * @return mixed
     */
    function getElementsByTagName($name, int $idx = - 1)
    {
